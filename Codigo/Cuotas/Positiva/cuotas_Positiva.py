...
def procesar_fila(driver,wait,row,ruta_carpeta_facturas,ruta_carpeta_comprobante):
    ...
    # Al inicio del script
    fechas_inicio = [fecha_opcion_1_inicio]
                                    ...
                                    if len(cells) > 20:
                                        ...
                                        try:
                                            ...
                                            if archivo_nuevo:
                                                ...
                                                ruta_final = os.path.join(ruta_carpeta_facturas, f"{num_poliza_birlik}_{comprobante_valor}.pdf")
                                            ...
                                            for fecha in fechas:
                                                ...
                                                if resultado is None:
                                                    ...
                                                    if estadoCuota_birlik == "Pendiente-comprobante":
                                                        ...
                                                        cancelar_y_agregar_cuota(driver,wait,id_cuota_birlik,comprobante_valor,fecha,ruta_final,ruta_imagen_sunat,resultado_importe)
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    print("\n📁 Iniciando procesamiento para Positiva...")
